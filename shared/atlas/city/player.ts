...
const WALK_SPEED_UNITS_PER_SECOND = 1.65;
const RUN_SPEED_UNITS_PER_SECOND = 3.4;
const MOVEMENT_DEAD_ZONE = 0.12;
const RUN_ENTER_THRESHOLD = 0.66;
const RUN_EXIT_THRESHOLD = 0.6;
const RUN_HOLD_SECONDS = 0.16;
const MINIMUM_WALK_SPEED_UNITS_PER_SECOND = 0.72;
const MINIMUM_RUN_SPEED_UNITS_PER_SECOND = 2.35;
const WALK_ACCELERATION_UNITS_PER_SECOND_SQUARED = 5.2;
const RUN_ACCELERATION_UNITS_PER_SECOND_SQUARED = 8;
const BRAKING_UNITS_PER_SECOND_SQUARED = 7.4;
